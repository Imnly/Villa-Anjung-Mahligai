...
function handleClick() {
  imagess.forEach((image) => image.classList.remove("active"));
  this.classList.add("active");
}

imagess.forEach((image) => image.addEventListener("click", handleClick));
...
var imagess = document.querySelectorAll('.gallery-image');
